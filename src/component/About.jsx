     ...
     return (
          <div id="about" className="bg-colorAbout px-8 py-12">
               <div className="container mx-auto flex flex-col lg:flex-row items-center">
                    {/* Text Section */}
                    <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0 px-10 py-14 mr-[800px]">
                         <h2 className="text-5xl text-right font-bold uppercase mb-7">
                              About
                         </h2>
                         <p className="text-gray-700 text-2xl leading-loose text-right pl-[20px]">
