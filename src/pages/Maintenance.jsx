...
const Maintenance = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-between bg-colorService">
      ...
      <div className="w-full py-4 border-t border-gray-300">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center text-gray-600 text-sm md:space-x-8 space-y-1 md:space-y-0">
          ...
          <a
            href="https://github.com/orgs/GlassWhisper/teams/capstone"
          ...
          >
            ...
            <span>github.com/glasswhisper</span>
          </a>
          <a
            href="mailto:capstoneglasswhisper@gmail.com"
            className="flex items-center space-x-1"
            target="_blank"
            rel="noopener noreferrer"
            title="Email"
          >
            ...
            <span>capstoneglasswhisper@gmail.com</span>
          </a>
        </div>
      </div>
    </div>
